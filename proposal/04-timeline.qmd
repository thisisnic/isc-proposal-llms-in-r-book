...
The intention is to release the contents under a "Creative Commons Attribution 4.0 International" (CC-BY) license.  The project is to be stored on GitHub on a public repository.
...
I would like to request financial support of 24080 USD from the ISC to develop the book materials, and transition the project to a community-owned resource.
The labour costs mentioned below use an hourly rate of $100, based on proposals for previous R Consortium sponsored projects.
...
- GitHub repository created with open license (CC-BY), Quarto structure, and contribution templates.
